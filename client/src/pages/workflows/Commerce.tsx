...
export default function Commerce() {
  ...
  useEffect(() => {
    startWorkflow('commerce', STEPS.length, nanoid());
  }, []);
  ...
  return (
    <>
      <Helmet><title>Creator Commerce - FlashFusion</title></Helmet>
      <WorkflowWizard steps={STEPS} onNext={handleNext} onBack={previousStep} backToOverview={true}>
        {currentStep === 1 && (
          <div className="max-w-4xl mx-auto space-y-6">
            <div className="text-center space-y-2">
              <h2 className="text-3xl font-bold">Choose Revenue Streams</h2>
            </div>
        ...
        {currentStep === 3 && (
          <div className="max-w-3xl mx-auto text-center space-y-6">
            ...
            <h2 className="text-3xl font-bold">Commerce System Active!</h2>
          </div>
        )}
      </WorkflowWizard>
    </>
